...
export const REPORTS: readonly ReportDefinition[] = [
  ...
  },
  {
    ...
    slug: "leave-usage",
    name: "Leave usage",
    purpose: "Balances against what was actually taken, for one leave year.",
    teamScoped: true,
    filters: ["year", "leaveType", "department", "location"],
    columns: [
      { key: "employee", label: "Employee" },
      { key: "employeeCode", label: "Code" },
      { key: "department", label: "Department" },
      { key: "leaveType", label: "Type" },
      { key: "opening", label: "Opening", format: "days" },
      { key: "accrued", label: "Accrued", format: "days" },
      { key: "carriedForward", label: "Carried", format: "days" },
      { key: "adjusted", label: "Adjusted", format: "days" },
      { key: "used", label: "Used", format: "days" },
      { key: "current", label: "Balance", format: "days" },
    ],
  },
  {
    id: "R7",
    slug: "leave-calendar",
    name: "Leave calendar",
    purpose: "Who is away, day by day, for one month.",
    teamScoped: true,
    filters: ["month", "leaveType", "department", "location"],
    columns: [
      { key: "date", label: "Date", format: "date" },
      { key: "employee", label: "Employee" },
      { key: "employeeCode", label: "Code" },
