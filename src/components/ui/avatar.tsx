...
function AvatarFallback({ className, ...props }: AvatarPrimitive.Fallback.Props) {
  return (
    <AvatarPrimitive.Fallback
      ...
      className={cn(
        "bg-brand-soft text-brand-soft-foreground flex size-full items-center justify-center rounded-full text-sm font-semibold group-data-[size=sm]/avatar:text-xs",
        className,
      )}
      {...props}
    />
